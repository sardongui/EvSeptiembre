...
<input id="investmentId" name="investmentId" type="hidden" value="${param.investmentId}"/>
	...
	<acme:form-moment code="authenticated.accounting-record.form.label.creationMoment" path="creationMoment" readonly="true"/>
	<acme:form-textbox code="authenticated.accounting-record.form.label.body" path="body"/>	
	<acme:form-textbox code="authenticated.accounting-record.form.label.status" path="status" readonly="true"/>	
